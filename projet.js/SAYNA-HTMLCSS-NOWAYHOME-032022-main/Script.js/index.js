...
var countDownDate = new Date("May 04, 2022 08:00:00").getTime();
...
var x = setInterval(function() {
    ...
    document.getElementById("spider").innerHTML = days + "d " + hours + "h " +
        minutes + "m " + seconds + "s ";
...
const send = document.getElementById('boss');
const para = document.getElementById('man');
const border = document.getElementById('pup');
const btn = document.querySelector('.me');

const inputs = document.getElementsByClassName('aa');
...
send.addEventListener('submit', function(e) {
    ...
    for (var i = 0; i < inputs.length; i++) {
        if (inputs[i].value == '') {
            ...
            para.innerText = 'remplir votre formulaire'
            return false
        } else {
            border.style.display = 'block'
            para.innerText = 'votre formulaire est accédé'
        }
